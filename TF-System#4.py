...
sysName = 'TF-System#4' #System Name here
initCapital = 500000
commission = 50
...
for curMarket in range(0,numMarkets):
    parabolicList.append(parabolicClass()) # instantiating a list of Parabolic
...
#---------------------------------------------------------------------------------
        ...
        if masterDateList[curPortBar] in marketMonitorList[curMarket].marketData.date:
            ...
            if curBar <= rampUp: continue  #not enough data for this particular market - cycle
...
#  Build some weekly bars
            ...
            posSize = 1
#            print(myDate[curBar]," ParOp :",parabOp," ",parabPos," ",myHigh[curBar]," ",myLow[curBar]);
